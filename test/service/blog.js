...
//             let blogId = await blogService.create({
//                 title: 'test',
//                 content: 'test blog',
//                 summary: 'no summary'
//             }, ['tag1', 'tag2'])
...
//                 content: 'test blog 2'
//             })
//             blogId.should.equal(2)
//         })

//         it('should not success when add a blog without title or content', async () => {
//             let error1 = await blogService.create({
//                 content: 'test3 without title'
//             })
//             let error2 = await blogService.create({
//                 title: 'test4 without content'
//             })
//             error1.errorCode.should.equal(1)
//             error2.errorCode.should.equal(1)
//             blogService.query(3).should.not.exist
//         })
